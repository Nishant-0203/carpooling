          ...
          <Card className="backdrop-blur-lg bg-white/10 border-white/20 shadow-2xl">
            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                {/* Email Field */}
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3, duration: 0.5 }} className="space-y-2">
                ...
                {/* Password Field */}
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4, duration: 0.5 }} className="space-y-2">
                ...
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5, duration: 0.5 }} className="space-y-2">
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8, duration: 0.5 }}>
                ...
                >
                  <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                    ...
                    <path fill="currentColor" d="M12 23c2.97 0 5.46-.98 7.28-2.66..." />
                    <path fill="currentColor" d="M5.84 14.09c-.22-.66-.35-1.36..." />
                    <path fill="currentColor" d="M12 5.38c1.62 0 3.06.56 4.21..." />
                  </svg>
              ...
              {/* Sign In Redirect */}
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9, duration: 0.5 }} className="text-center">
